...
export const GetMemberUserData = (token) => async (dispatch) => {
    ...
    return await axios.get("https://tmetric-backend.vercel.app/member/user", {
        headers: {
...
export const PostMemberSignup = (payload) => async (dispatch) => {
    ...
    return await axios.post(`https://tmetric-backend.vercel.app/member/`, payload, {
        headers: {
            'Content-Type': 'application/json',
...
export const GetMemberData = (token) => async (dispatch) => {
    ...
    return await axios.get("https://tmetric-backend.vercel.app/member/", {
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
        }
...
export const UpdateMember = (payload) => async (dispatch) => {
    ...
    // console.log(getLocalData("token"))
    return await axios.patch(`https://tmetric-backend.vercel.app/member/${payload.userId}`, payload, {
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${payload.token}`
        }
...
export const DeleteMemberFun = (payload) => async (dispatch) => {
    ...
    // console.log(getLocalData("token"))
    return await axios.delete(`https://tmetric-backend.vercel.app/member/${payload.userId}`, {
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${payload.token}`
        }
